...
typedef enum { A_numIndexKind, A_idIndexKind } A_indexExprKind;
...
typedef enum { A_neg } A_arithUOp;

typedef enum { A_add, A_sub, A_mul, A_div } A_arithBiOp;

typedef enum { A_not } A_boolUOp;

typedef enum { A_and, A_or } A_boolBiOp;
...
typedef enum { A_arithBiOpExprKind, A_exprUnitKind } A_arithExprType;

typedef enum { A_boolBiOpExprKind, A_boolUnitKind } A_boolExprType;
...
typedef enum { A_arithExprValKind, A_boolExprValKind } A_rightValType;

typedef enum { A_varValKind, A_arrValKind, A_memberValKind } A_leftValType;

typedef enum { A_varDeclKind, A_varDefKind } A_varDeclStmtType;

typedef enum { A_varDeclScalarKind, A_varDeclArrayKind } A_varDeclType;

typedef enum { A_varDefScalarKind, A_varDefArrayKind } A_varDefType;
...
A_arithBiOpExpr A_ArithBiOpExpr(A_pos pos, A_arithBiOp op, A_arithExpr left,
                                A_arithExpr right);
...
A_boolBiOpExpr A_BoolBiOpExpr(A_pos pos, A_boolBiOp op, A_boolExpr left,
                              A_boolExpr right);
...
A_varDefArray A_VarDefArray(A_pos pos, char* id, int len, A_type type,
                            A_rightValList vals);
...
A_codeBlockStmtList A_CodeBlockStmtList(A_codeBlockStmt head,
                                        A_codeBlockStmtList tail);
A_fnDef A_FnDef(A_pos pos, A_fnDecl fnDecl, A_codeBlockStmtList stmts);
A_ifStmt A_IfStmt(A_pos pos, A_boolUnit boolUnit, A_codeBlockStmtList ifStmts,
                  A_codeBlockStmtList elseStmts);
A_whileStmt A_WhileStmt(A_pos pos, A_boolUnit boolUnit,
                        A_codeBlockStmtList whileStmts);
...
A_programElementList A_ProgramElementList(A_programElement head,
                                          A_programElementList tail);
